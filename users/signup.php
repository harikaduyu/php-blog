    ...
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        if($stmt = mysqli_prepare($conn, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                header("location: /php-blog/users/login.php");
            } else{
...
<?php include($_SERVER['DOCUMENT_ROOT'] .'/php-blog/templates/base_layout.php'); ?>
        ...
        <form class="site-form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            <div class="form-group <?php echo (!empty($username_err)) ? 'has-error' : ''; ?>">
                <label>Username</label>
                <input type="text" name="username" class="form-control" value="<?php echo $username; ?>">
                <span class="errorlist"><?php echo $username_err; ?></span>
            </div> 
            <br>
            ...
            <div class="form-group <?php echo (!empty($password_err)) ? 'has-error' : ''; ?>">
                ...
                <span class="errorlist"><?php echo $password_err; ?></span>
            </div>
            <br>
            ...
            <div class="form-group <?php echo (!empty($confirm_password_err)) ? 'has-error' : ''; ?>">
                ...
                <span class="errorlist"><?php echo $confirm_password_err; ?></span>
            </div>
